...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkDown = () => {
        if (this.checkValideInput()) {
            ...
            this.setState({
                ...
                selectedClinic: this.props.clinic[0].id,
                nameClinic: '',
                note: '',
            })
        }
    ...
    render() {
        let { hasOldData, listPrice, listProvince, listPayment,
            addressClinic, nameClinic, note, description, listSpecialty, listClinic } = this.state;
        let { language } = this.props;
        return (
